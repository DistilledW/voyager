...
#define PURE_FORWARD 1
#define OPACITY_AABB 1
...
__device__ const float lowest_alpha_coeff = 5.54126354515842f;
...
__device__ constexpr float inv_exp_lut_step = -31.0f/5.6f;

__device__ const float lut[] = {
1.0,
0.8347315012000831,
0.6967766790957444,
0.5816214433427993,
