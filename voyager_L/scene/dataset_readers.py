...
def readColmapSceneInfo(path, images, masks, depths, eval, train_test_exp, llffhold=None, test="test.txt"):
    try:
    ...
    if eval:
        ...
        if llffhold:
            ...
            if test != None:
                with open(os.path.join(path, "sparse/0/tests", test), 'r') as file:
