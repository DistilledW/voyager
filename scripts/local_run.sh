...
do 
    ...
    # LOGS_DIR="${PROJECT}/dataset/logs/local_test/${DATASET}/${scene}/performance"
    # mkdir -p "${LOGS_DIR}" 
    # for tau in "${Taus[@]}"; 
    # do 
    #     python ${PYTHON_FILE} \
    ...
    #         "${ARGS[@]}" 
    # done 
    LOGS_DIR="/workspace/code/dataset/logs/local_test/${DATASET}/${scene}/performance/$SEQ"
    mkdir -p "${LOGS_DIR}" 
    for tau in "${Taus[@]}"; 
    do 
    ...
    # LOGS_DIR="${PROJECT}/dataset/logs/local_test/${DATASET}/${scene}/accuracy" 
    # RENDERS="${PROJECT}/dataset/logs/local_test/${DATASET}/${scene}/renders" 
    # mkdir -p "${LOGS_DIR}" 
    # for tau in "${Taus[@]}"; 
    # do 
    #     mkdir -p "${RENDERS}/${tau}" 
    #     python ${PYTHON_FILE}  --train_test_exp \
    #         --log_file "${LOGS_DIR}/${tau}.txt" \
    #         --taus ${tau} \
